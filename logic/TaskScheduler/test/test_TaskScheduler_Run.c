...
static TS_TimeStruct dummy_task2_planNext(void);

static void dummy_task3(void);
static TS_TimeStruct dummy_task3_planNext(void);
...
static TS_TimeStruct task2_planNextRetVal = {0};
static TS_TimeStruct task3_planNextRetVal = {0};
...
void setUp(void)
{
    ...
    memset(&task2_planNextRetVal, 0x00, sizeof(TS_TimeStruct));
    memset(&task3_planNextRetVal, 0x00, sizeof(TS_TimeStruct));
}
...
void test_TaskScheduler_run_multiple_tasks_properly_assigned(void)
{
    //ARRANGE
    TS_TimeStruct task1_currTimeInst = {0};
    TS_TimeStruct task2_currTimeInst = {0};
    TS_TimeStruct task3_currTimeInst = {0};
